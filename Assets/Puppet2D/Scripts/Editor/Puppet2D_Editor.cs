...
//		}
//
//		if (GUI.Button(new Rect(80, 280, 150, 30),"Create Spline Tool" ))
//		{  
//			splineCtrls.Clear();
//			SplineCreation = true; 
//			
...
//			GUI.backgroundColor = bgColor;
//		}
//		numberSplineJoints = EditorGUI.IntSlider(new Rect(80, 315, 150, 20), numberSplineJoints, 1, 10);
//
//		if (GUI.Button(new Rect(80, 340, 150, 30),"Finish Spline Tool" ))
//		{   
...
//		}
        ...
        VertexHandleSize = EditorGUI.Slider(new Rect(80, 520, 150, 20), VertexHandleSize, 0F, .9999F);
    ...
    static void IKCreateTool()
    {
        ...
        if (globalCtrl.GetComponent<Puppet2D_GlobalControl>().refresh)
